...
public class BankingAccountDetailAllOf   {
  ...
  */
  ...
  public BankingAccountDetailAllOf termDeposit(BankingTermDepositAccount termDeposit) {
  ...
  */
  ...
  public BankingAccountDetailAllOf features(List<String> features) {
    this.features = features;
    return this;
  }

  public BankingAccountDetailAllOf addFeaturesItem(String featuresItem) {

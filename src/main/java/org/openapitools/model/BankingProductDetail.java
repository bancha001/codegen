...
import org.openapitools.model.BankingProductAdditionalInformation;
import org.openapitools.model.BankingProductBundle;
import org.openapitools.model.BankingProductCategory;
import org.openapitools.model.BankingProductConstraint;
import org.openapitools.model.BankingProductDepositRate;
import org.openapitools.model.BankingProductDetailAllOf;
...
public class BankingProductDetail   {
  ...
  /**
   * A holder specific unique identifier for this product. This identifier must be unique to a product but does not otherwise need to adhere to ID permanence guidelines.
   * @return productId
  */
  @ApiModelProperty(required = true, value = "A holder specific unique identifier for this product. This identifier must be unique to a product but does not otherwise need to adhere to ID permanence guidelines.")
  @NotNull
